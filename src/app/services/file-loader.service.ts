...
export class FileLoaderService {
  ...
  pushFileTreeToStorage(
    ...
    const request = new HttpRequest(
      "POST",
      "http://localhost:8081/uploadFileTree",
      formData,
      {
        reportProgress: true,
        responseType: "text"
  ...
  getFiles(panelName): Observable<any> {
    ...
    return this.http.get("http://localhost:8081/getAllFiles", {
      params: params
    });
  }
  ...
  getFilesTree(panelName, galleryName): Observable<any> {
    ...
    return this.http.get("http://localhost:8081/getAllGalleryFiles", {
      params: params
    });
  }
}
